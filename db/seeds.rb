...
Cuisine.create(
	[ { name: 'Mexican', 
	    img_path: "img/cuisine/MexicanCuisine.jpg", 
	    ...
	    { name: 'Indian', 
    	img_path: "img/cuisine/IndianCuisine.jpg", 
	    ...
	    { name: 'Caribbean', 
    	img_path: "img/cuisine/CaribbeanCuisine.jpg", 
	    ...
	    { name: 'North African', 
    	img_path: "img/cuisine/NorthAfricanCuisine.jpg", 
	    ...
	    { name: 'Cajun', 
    	img_path: "img/cuisine/CajunCuisine.jpg", 
	    ...
	    { name: 'Mediterranean', 
    	img_path: "img/cuisine/MediterraneanCuisine.jpg", 
	    ...
	    { name: 'Middle Eastern', 
    	img_path: "img/cuisine/MiddleEasternCuisine.jpg", 
